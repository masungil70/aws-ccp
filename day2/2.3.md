...
그래서 학생들에게 아래와 같은 **프로젝트 스토리**로 설명합니다.
...
** AWS에서는 여러 요소를 종합하여 **TCO(Total Cost of Ownership, 총소유비용)** 를 계산한 후 절감률을 산출합니다.

계산식은 매우 단순합니다.

<img width="872" height="128" alt="image" src="https://github.com/user-attachments/assets/9c6c2661-760d-48aa-98dc-71b0d880541d" />
...
AWS Migration Evaluator는 아래 항목을 모두 계산합니다.

### ① EC2 비용

CPU 사용률이 평균 28%입니다.

즉 현재 서버가 과하게 큰 경우가 많습니다.
...
### ② Reserved Instance / Savings Plans 적용

Migration Evaluator는
...
<img width="1014" height="523" alt="image" src="https://github.com/user-attachments/assets/4867b787-015d-4875-94c0-b89f5969adad" />
...
# AWS Migration Evaluator가 실제 사용하는 분석 요소

실제로는 다음 데이터를 기반으로 매우 상세하게 계산합니다.
...
즉 단순히 서버 개수만 보는 것이 아니라 **성능 사용률, 라이선스, 스토리지, 네트워크, 운영 방식까지 포함한 TCO 분석**을 수행합니다.
